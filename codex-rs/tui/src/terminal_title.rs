...
//! "leave the old title alone" or "clear the title MidnightCoder last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title MidnightCoder manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before MidnightCoder started managing the title.
