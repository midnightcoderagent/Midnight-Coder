...
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    ...
    "midnight-coder-darwin-x64": {
        "npm_name": "midnight-coder-darwin-x64",
        "npm_tag": "darwin-x64",
        "target_triple": "x86_64-apple-darwin",
        "os": "darwin",
        "cpu": "x64",
    },
    "midnight-coder-darwin-arm64": {
        "npm_name": "midnight-coder-darwin-arm64",
...
PACKAGE_NATIVE_COMPONENTS: dict[str, list[str]] = {
    ...
    "midnight-coder-darwin-x64": [CODEX_PACKAGE_COMPONENT],
    "midnight-coder-darwin-arm64": [CODEX_PACKAGE_COMPONENT],
